...
public class JsonUtils {
    ...
    final static String apiVal = "XXXX";
final static String trailer_BASE_URL ="238/videos?api_key=XXXX";
    final static String review_BASE_URL ="238/reviews?api_key=XXXX";
